...
with open('/home/alireza/PycharmProjects/PW_Federated_Learning/data/Sheks/100.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
class BigramLanguageModel(nn.Module):
    def __init__(self, vocab_size):
        ...
        self.token_embedding_table = nn.Embedding(vocab_size, 8)
